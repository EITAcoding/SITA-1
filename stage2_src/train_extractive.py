...
from models.model_builder import ExtSummarizer,ExtSummarizer1,ExtSummarizer2,ExtSummarizer3
...
def test_ext(args, device_id, pt, step):
    ...
    model = ExtSummarizer1(args, device, checkpoint)
    model.eval()
    ...
    trainer = build_trainer(args, device_id, model, None)
    trainer.New_test(test_iter, step)
