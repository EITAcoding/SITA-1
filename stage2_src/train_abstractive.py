...
from models.model_builder import AbsSummarizer,AbsSummarizer_new,AbsSummarizer_3
...
def test_abs(args, device_id, pt, step):
    ...
    model =  AbsSummarizer_3(args, device, checkpoint)
    model.eval()
...
def train_abs_single(args, device_id):
    ...
    model = AbsSummarizer_3(args, device, checkpoint, bert_from_extractive)
