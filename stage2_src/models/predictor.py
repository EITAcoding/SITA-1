...
class Translator(object):
    ...
    def from_batch(self, translation_batch):
        ...
        preds, pred_score, gold_score, tgt_str, src,hash_code =  translation_batch["predictions"],translation_batch["scores"],translation_batch["gold_score"], batch.tgt_str, batch.src, batch.hash_code
        ...
        for b in range(batch_size):
            ...
            translation = (pred_sents, gold_sent, raw_src,temp_hash)
    ...
    def translate(self,
        ...
        with torch.no_grad():
            for batch in data_iter:
                ...
                if batch_data==None:continue
                translations = self.from_batch(batch_data)

                for trans in translations:
                    pred, gold, src ,hash_code= trans
                    ...
                    # print('INFO: write pred summary to ',hash_code)
                    # pre_f = open('/tf/home_project/PreSumm/data/soft_data/stage2_test_pred_smmary/'+hash_code+'.txt','w+')
                    # pre_f.writelines(pred_str)
                    # pre_f.close()
    ...
    def _fast_translate_batch(self,
        ...
        ic = batch.ic
        segs_ic = batch.segs_ic
        mask_ic = batch.mask_ic
        mask_clss_ic = batch.mask_clss_ic
        if ic.shape[-1]>512:
            # print('change_before',ic.shape,mask_ic.shape)
            # ic = ic[:,:512]
            # mask_ic = mask_ic[:,:512]
            # print('change after:', ic.shape,mask_ic.shape)
            return None
        src_features = self.model.bert(src, segs, mask_src)
        ic_features = self.model.bert(ic, segs_ic,mask_ic)
        # print('$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$')
        # print(src_features.shape)
        # print(ic_features.shape)
        dec_states = self.model.decoder.init_decoder_state(src,ic, src_features,ic_features , with_cache=True )
        ...
        ic_features = tile(ic_features,beam_size,dim=0)
        ...
        alive_seq = torch.full(
            ...
            device=device)
        """
        python train.py -task abs -mode test -test_from ../msmo_models/abs_ic_model_3/model_step_88000.pt -batch_size 3000 -test_batch_size 500 -bert_data_path ../data/ic_msmo/bert_with_image_hash/ -log_file ../logs/val_abs_bert_cnndm  -sep_optim true -use_interval true -visible_gpus 2 -max_pos 512 -max_length 200 -alpha 0.95 -min_length 50 -result_path ../logs/abs_bert_cnndm
        """
        ...
        for step in range(max_length):
            ...
            dec_out, dec_states = self.model.decoder(decoder_input, src_features, ic_features, dec_states,step=step)
            ...
            ic_features = ic_features.index_select(0, select_indices.long())
            dec_states.map_batch_fn(
